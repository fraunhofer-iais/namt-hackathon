...
#  Default: ''
c.NotebookApp.notebook_dir = '/home/student'
...
#  password.
#  Default: ''
c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$UnqPRjSyFV26wiBt8p4kXA$8ZdVsRiuLAPnn+OvAe+V2jxBQlcfpfCHdwYxBdfJG+c'
...
#  Choices: any of ['sha3_384', 'sha1', 'md5', 'blake2b', 'sha256', 'sha3_224', 'sha512', 'sha3_512', 'sha3_256', 'sha384', 'blake2s', 'sha224']
#  Default: 'sha256'
